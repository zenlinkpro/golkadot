...
require (
	...
	github.com/libp2p/go-libp2p-discovery v0.0.0-20190218185344-d369eed95f2d // indirect
	github.com/libp2p/go-libp2p-gorpc v0.0.0-20190219150623-9bb9fe716191
	...
	github.com/libp2p/go-libp2p-kad-dht v4.4.20+incompatible
